...
class TackTracker:
    ...
    def mark_task_completed(self, t_id):
        sql_mark_task_completed = f"""
            UPDATE tasks SET task_type=2 WHERE id={t_id} OR parent_id={t_id}
        """
    ...
    def assign_task_to_user(self, t_id, u_name):
        sql_add_user_id_in_tasks = f"""
            ...
            WHERE id={t_id} OR parent_id={t_id}
        """
...
if __name__ == '__main__':
    ...
    t_tracker.add_task()
    t_tracker.mark_task_completed(9)
    t_tracker.create_user('Lion')
    t_tracker.assign_task_to_user(14, 'Lion')
    t_tracker.add_task()
    t_tracker.add_task()
    print(t_tracker.get_tasks_list())
    t_tracker.add_sub_task(25, 26)
    t_tracker.mark_task_completed(25)